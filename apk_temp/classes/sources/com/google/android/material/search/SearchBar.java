...
public class SearchBar extends Toolbar {
    ...
    /* synthetic */ void m106lambda$new$0$comgoogleandroidmaterialsearchSearchBar(boolean enabled) {
    ...
    public SearchBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: com.google.android.material.search.SearchBar$$ExternalSyntheticLambda0
            ...
            public final void onTouchExplorationStateChanged(boolean z) {
                this.f$0.m106lambda$new$0$comgoogleandroidmaterialsearchSearchBar(z);
            }
        };
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, R.styleable.SearchBar, defStyleAttr, i, new int[0]);
    ...
    private void initBackground(ShapeAppearanceModel shapeAppearance, int backgroundColor, float elevation, float strokeWidth, int strokeColor) {
        ...
        ColorStateList colorStateListValueOf = ColorStateList.valueOf(rippleColor);
        MaterialShapeDrawable materialShapeDrawable2 = this.backgroundShape;
        Drawable background = new RippleDrawable(colorStateListValueOf, materialShapeDrawable2, materialShapeDrawable2);
