...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray selectedTabTA = context2.obtainStyledAttributes(resourceId, androidx.appcompat.R.styleable.TextAppearance);
        try {
            ...
            if (a.hasValue(R.styleable.TabLayout_tabSelectedTextAppearance)) {
                this.selectedTabTextAppearance = a.getResourceId(R.styleable.TabLayout_tabSelectedTextAppearance, resourceId);
            }
            int i2 = this.selectedTabTextAppearance;
            if (i2 != -1) {
                selectedTabTA = context2.obtainStyledAttributes(i2, androidx.appcompat.R.styleable.TextAppearance);
                try {
    ...
    public void setSelectedTabIndicator(Drawable tabSelectedIndicator) {
        ...
        Drawable drawableMutate = DrawableCompat.wrap(tabSelectedIndicator).mutate();
