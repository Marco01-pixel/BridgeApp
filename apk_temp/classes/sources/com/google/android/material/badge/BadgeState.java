...
public final class BadgeState {
    ...
    BadgeState(Context context, int badgeResId, int defStyleAttr, int defStyleRes, State storedState) {
        ...
        state.badgeHorizontalPadding = Integer.valueOf(iIntValue8);
        ...
        state.badgeVerticalPadding = Integer.valueOf(iIntValue9);
        ...
        state.horizontalOffsetWithoutText = Integer.valueOf(iIntValue10);
        ...
        state.verticalOffsetWithoutText = Integer.valueOf(iIntValue11);
        if (storedState.horizontalOffsetWithText == null) {
            iIntValue12 = a.getDimensionPixelOffset(R.styleable.Badge_horizontalOffsetWithText, state.horizontalOffsetWithoutText.intValue());
        } else {
            iIntValue12 = storedState.horizontalOffsetWithText.intValue();
        }
        state.horizontalOffsetWithText = Integer.valueOf(iIntValue12);
        if (storedState.verticalOffsetWithText == null) {
            iIntValue13 = a.getDimensionPixelOffset(R.styleable.Badge_verticalOffsetWithText, state.verticalOffsetWithoutText.intValue());
        } else {
            iIntValue13 = storedState.verticalOffsetWithText.intValue();
        }
        state.verticalOffsetWithText = Integer.valueOf(iIntValue13);
        ...
        state.largeFontVerticalOffsetAdjustment = Integer.valueOf(iIntValue14);
        ...
        state.autoAdjustToWithinGrandparentBounds = Boolean.valueOf(zBooleanValue);
        a.recycle();
