...
class EndCompoundLayout extends LinearLayout {
    ...
    EndCompoundLayout(TextInputLayout textInputLayout, TintTypedArray a) {
        ...
        CheckableImageButton checkableImageButtonCreateIconView = createIconView(this, layoutInflater, R.id.text_input_error_icon);
        this.errorIconView = checkableImageButtonCreateIconView;
        CheckableImageButton checkableImageButtonCreateIconView2 = createIconView(frameLayout, layoutInflater, R.id.text_input_end_icon);
