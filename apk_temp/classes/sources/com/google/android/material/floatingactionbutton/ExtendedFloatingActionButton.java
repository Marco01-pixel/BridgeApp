...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    public ExtendedFloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int i2 = a.getInt(R.styleable.ExtendedFloatingActionButton_extendStrategy, 1);
        this.extendStrategyType = i2;
        ...
        ChangeSizeStrategy changeSizeStrategy = new ChangeSizeStrategy(changeSizeTracker, getSizeFromExtendStrategyType(i2), true);
        this.extendStrategy = changeSizeStrategy;
        ChangeSizeStrategy changeSizeStrategy2 = new ChangeSizeStrategy(changeSizeTracker, new Size() { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.1
