...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    public MaterialCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray attributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attrs, R.styleable.MaterialCheckBox, defStyleAttr, i, new int[0]);
    ...
    public void setCheckedState(int checkedState) {
        ...
        if (this.checkedState != checkedState) {
            ...
            if (linkedHashSet != null) {
                for (OnCheckedStateChangedListener listener : linkedHashSet) {
