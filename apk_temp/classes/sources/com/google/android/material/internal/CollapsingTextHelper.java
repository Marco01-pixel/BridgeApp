...
public final class CollapsingTextHelper {
    ...
    private void calculateOffsets(float fraction) throws StaticLayoutBuilderCompat.StaticLayoutBuilderCompatException {
        ...
        int iBlendARGB = blendARGB(getCurrentColor(this.expandedShadowColor), getCurrentColor(this.collapsedShadowColor), fraction);
    ...
    private void setInterpolatedTextSize(float fraction) throws StaticLayoutBuilderCompat.StaticLayoutBuilderCompatException {
    ...
    private void calculateUsingTextSize(float fraction) throws StaticLayoutBuilderCompat.StaticLayoutBuilderCompatException {
        calculateUsingTextSize(fraction, false);
    }

    private void calculateUsingTextSize(float fraction, boolean forceRecalculate) throws StaticLayoutBuilderCompat.StaticLayoutBuilderCompatException {
        float newTextSize;
    ...
    public void setStaticLayoutBuilderConfigurer(StaticLayoutBuilderConfigurer staticLayoutBuilderConfigurer) throws StaticLayoutBuilderCompat.StaticLayoutBuilderCompatException {
