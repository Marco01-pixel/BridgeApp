...
final class Arrangement {
    ...
    private void fit(float availableSpace, float minSmallSize, float maxSmallSize, float targetLargeSize) {
        ...
        this.smallSize = f3;
        float fCalculateLargeSize = calculateLargeSize(availableSpace, i2, f3, this.mediumCount, this.largeCount);
        this.largeSize = fCalculateLargeSize;
        float f4 = (this.smallSize + fCalculateLargeSize) / 2.0f;
        this.mediumSize = f4;
        int i3 = this.mediumCount;
        if (i3 > 0 && fCalculateLargeSize != targetLargeSize) {
            float targetAdjustment = (targetLargeSize - fCalculateLargeSize) * this.largeCount;
