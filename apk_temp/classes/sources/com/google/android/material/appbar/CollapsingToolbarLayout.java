...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) throws StaticLayoutBuilderCompat.StaticLayoutBuilderCompatException {
        ensureToolbar();
    ...
    private void updateTextBounds(int left, int top, int right, int bottom, boolean forceRecalculate) throws StaticLayoutBuilderCompat.StaticLayoutBuilderCompatException {
        View view;
        if (this.collapsingTitleEnabled && (view = this.dummyView) != null) {
