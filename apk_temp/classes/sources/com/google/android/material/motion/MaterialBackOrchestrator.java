...
public final class MaterialBackOrchestrator {
    ...
    private static class Api33BackCallbackDelegate implements BackCallbackDelegate {
        ...
        public void startListeningForBackCallbacks(MaterialBackHandler backHandler, View view, boolean priorityOverlay) {
            ...
            OnBackInvokedCallback onBackInvokedCallbackCreateOnBackInvokedCallback = createOnBackInvokedCallback(backHandler);
            ...
            onBackInvokedDispatcher.registerOnBackInvokedCallback(priority, onBackInvokedCallbackCreateOnBackInvokedCallback);
        }
