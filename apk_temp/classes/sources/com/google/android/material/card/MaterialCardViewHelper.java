...
class MaterialCardViewHelper {
    ...
    public void animateCheckedIcon(boolean checked) {
        ...
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(this.checkedAnimationProgress, targetCheckedProgress);
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.card.MaterialCardViewHelper$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f$0.m53xa4d79c2b(valueAnimator2);
            }
        });
    ...
    /* synthetic */ void m53xa4d79c2b(ValueAnimator animation) {
    ...
    void setCheckedIcon(Drawable checkedIcon) {
        if (checkedIcon != null) {
            Drawable drawableMutate = DrawableCompat.wrap(checkedIcon).mutate();
