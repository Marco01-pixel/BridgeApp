...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    public MaterialCardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(context2, attrs, com.google.android.material.R.styleable.MaterialCardView, defStyleAttr, i, new int[0]);
