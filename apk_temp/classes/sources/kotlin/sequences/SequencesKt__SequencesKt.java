        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c00451 = this;
                    sequenceScope = (SequenceScope) c00451.L$0;
                    mutableList = SequencesKt.toMutableList(c00451.$this_shuffled);
                    break;
                case 1:
                    c00451 = this;
                    mutableList = (List) c00451.L$1;
                    SequenceScope sequenceScope2 = (SequenceScope) c00451.L$0;
                    ResultKt.throwOnFailure(obj);
            ...
            while (!mutableList.isEmpty()) {
                int iNextInt = c00451.$random.nextInt(mutableList.size());
                ...
                c00451.L$0 = sequenceScope;
                c00451.L$1 = mutableList;
                c00451.label = 1;
                if (sequenceScope.yield(objRemoveLast, c00451) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            return Unit.INSTANCE;
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c00401 = this;
                    sequenceScope = (SequenceScope) c00401.L$0;
                    i = 0;
                    it = c00401.$source.iterator();
                    break;
                case 1:
                    c00401 = this;
                    i = c00401.I$0;
                    it = (Iterator) c00401.L$1;
                    sequenceScope = (SequenceScope) c00401.L$0;
                    ResultKt.throwOnFailure(obj);
                    break;
                default:
            ...
            while (it.hasNext()) {
                Object next = it.next();
                Function2<Integer, T, C> function2 = c00401.$transform;
                int i2 = i + 1;
                if (i < 0) {
                    CollectionsKt.throwIndexOverflow();
                }
                Object objInvoke = function2.invoke(Boxing.boxInt(i), (T) next);
                c00401.L$0 = sequenceScope;
                c00401.L$1 = it;
                c00401.I$0 = i2;
                c00401.label = 1;
                if (sequenceScope.yieldAll(c00401.$iterator.invoke((C) objInvoke), c00401) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                i = i2;
            }
