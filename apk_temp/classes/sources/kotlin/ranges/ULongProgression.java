...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM323constructorimpl = ((int) ULong.m323constructorimpl(j ^ ULong.m323constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM323constructorimpl2 = (iM323constructorimpl + ((int) ULong.m323constructorimpl(j2 ^ ULong.m323constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM323constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) ULong.m369toStringimpl(this.first)).append("..").append((Object) ULong.m369toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) ULong.m369toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m369toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
