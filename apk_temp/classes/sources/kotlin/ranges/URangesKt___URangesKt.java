...
public class URangesKt___URangesKt {
    ...
    public static final UInt firstOrNull(UIntProgression $this$firstOrNull) {
        ...
        return UInt.m238boximpl($this$firstOrNull.getFirst());
    }
    ...
    public static final ULong firstOrNull(ULongProgression $this$firstOrNull) {
        ...
        return ULong.m317boximpl($this$firstOrNull.getFirst());
    }
    ...
    public static final UInt lastOrNull(UIntProgression $this$lastOrNull) {
        ...
        return UInt.m238boximpl($this$lastOrNull.getLast());
    }
    ...
    public static final ULong lastOrNull(ULongProgression $this$lastOrNull) {
        ...
        return ULong.m317boximpl($this$lastOrNull.getLast());
    }
    ...
    public static final UInt randomOrNull(UIntRange $this$randomOrNull, Random random) {
        ...
        return UInt.m238boximpl(URandomKt.nextUInt(random, $this$randomOrNull));
    }
    ...
    public static final ULong randomOrNull(ULongRange $this$randomOrNull, Random random) {
        ...
        return ULong.m317boximpl(URandomKt.nextULong(random, $this$randomOrNull));
    }
    ...
    public static final boolean m1416contains68kG9v0(UIntRange contains, byte value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1389containsWZ4Q5Ns(UInt.m244constructorimpl(value & UByte.MAX_VALUE));
    }
    ...
    public static final boolean m1419containsULbyJY(ULongRange contains, byte value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1398containsVKZWuLQ(ULong.m323constructorimpl(((long) value) & 255));
    }
    ...
    public static final boolean m1418containsGab390E(ULongRange contains, int value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1398containsVKZWuLQ(ULong.m323constructorimpl(((long) value) & 4294967295L));
    }
    ...
    public static final boolean m1422containsfz5IDCE(UIntRange contains, long value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return ULong.m323constructorimpl(value >>> 32) == 0 && contains.m1389containsWZ4Q5Ns(UInt.m244constructorimpl((int) value));
    }
    ...
    public static final boolean m1420containsZsK3CEQ(UIntRange contains, short value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1389containsWZ4Q5Ns(UInt.m244constructorimpl(65535 & value));
    }
    ...
    public static final boolean m1423containsuhHAxoY(ULongRange contains, short value) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1398containsVKZWuLQ(ULong.m323constructorimpl(((long) value) & 65535));
    }
    ...
    public static final UIntProgression m1426downToKr8caGY(byte $this$downTo_u2dKr8caGY, byte to) {
        return UIntProgression.INSTANCE.m1386fromClosedRangeNkh28Cs(UInt.m244constructorimpl($this$downTo_u2dKr8caGY & UByte.MAX_VALUE), UInt.m244constructorimpl(to & UByte.MAX_VALUE), -1);
    }
    ...
    public static final UIntProgression m1424downTo5PvTz6A(short $this$downTo_u2d5PvTz6A, short to) {
        return UIntProgression.INSTANCE.m1386fromClosedRangeNkh28Cs(UInt.m244constructorimpl($this$downTo_u2d5PvTz6A & UShort.MAX_VALUE), UInt.m244constructorimpl(65535 & to), -1);
    }
    ...
    public static final UIntRange m1430untilKr8caGY(byte $this$until_u2dKr8caGY, byte to) {
        return Intrinsics.compare(to & UByte.MAX_VALUE, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(UInt.m244constructorimpl($this$until_u2dKr8caGY & UByte.MAX_VALUE), UInt.m244constructorimpl(UInt.m244constructorimpl(to & UByte.MAX_VALUE) - 1), null);
    }
    ...
    public static final UIntRange m1429untilJ1ME1BU(int $this$until_u2dJ1ME1BU, int to) {
        return Integer.compareUnsigned(to, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange($this$until_u2dJ1ME1BU, UInt.m244constructorimpl(to - 1), null);
    }
    ...
    public static final ULongRange m1431untileb3DHEI(long $this$until_u2deb3DHEI, long to) {
        return Long.compareUnsigned(to, 0L) <= 0 ? ULongRange.INSTANCE.getEMPTY() : new ULongRange($this$until_u2deb3DHEI, ULong.m323constructorimpl(to - ULong.m323constructorimpl(((long) 1) & 4294967295L)), null);
    }
    ...
    public static final UIntRange m1428until5PvTz6A(short $this$until_u2d5PvTz6A, short to) {
        return Intrinsics.compare(to & UShort.MAX_VALUE, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(UInt.m244constructorimpl($this$until_u2d5PvTz6A & UShort.MAX_VALUE), UInt.m244constructorimpl(UInt.m244constructorimpl(65535 & to) - 1), null);
    }
    ...
    public static final int m1412coerceInWZ9TVnA(int $this$coerceIn_u2dWZ9TVnA, int minimumValue, int maximumValue) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UInt.m290toStringimpl(maximumValue)) + " is less than minimum " + ((Object) UInt.m290toStringimpl(minimumValue)) + '.');
    }
    ...
    public static final long m1414coerceInsambcqE(long $this$coerceIn_u2dsambcqE, long minimumValue, long maximumValue) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) ULong.m369toStringimpl(maximumValue)) + " is less than minimum " + ((Object) ULong.m369toStringimpl(minimumValue)) + '.');
    }
    ...
    public static final byte m1413coerceInb33U2AM(byte $this$coerceIn_u2db33U2AM, byte minimumValue, byte maximumValue) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UByte.m211toStringimpl(maximumValue)) + " is less than minimum " + ((Object) UByte.m211toStringimpl(minimumValue)) + '.');
    }
    ...
    public static final short m1411coerceInVKSA0NQ(short $this$coerceIn_u2dVKSA0NQ, short minimumValue, short maximumValue) {
        ...
        throw new IllegalArgumentException("Cannot coerce value to an empty range: maximum " + ((Object) UShort.m474toStringimpl(maximumValue)) + " is less than minimum " + ((Object) UShort.m474toStringimpl(minimumValue)) + '.');
    }
    ...
    public static final int m1415coerceInwuiCnnA(int $this$coerceIn_u2dwuiCnnA, ClosedRange<UInt> range) {
        ...
        if (range instanceof ClosedFloatingPointRange) {
            return ((UInt) RangesKt.coerceIn(UInt.m238boximpl($this$coerceIn_u2dwuiCnnA), (ClosedFloatingPointRange<UInt>) range)).getData();
        }
        if (range.isEmpty()) {
    ...
    public static final long m1410coerceInJPwROB0(long $this$coerceIn_u2dJPwROB0, ClosedRange<ULong> range) {
        Intrinsics.checkNotNullParameter(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((ULong) RangesKt.coerceIn(ULong.m317boximpl($this$coerceIn_u2dJPwROB0), (ClosedFloatingPointRange<ULong>) range)).getData();
        }
        if (range.isEmpty()) {
            throw new IllegalArgumentException("Cannot coerce value to an empty range: " + range + '.');
        }
