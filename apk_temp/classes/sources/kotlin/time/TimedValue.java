...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1632copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1634copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m1634copyRFiDyg4(T value, long duration) {
    ...
    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m1503hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m1524toStringimpl(this.duration)) + ')';
    }
    ...
    public final long m1635getDurationUwyO8pc() {
        return this.duration;
    }
