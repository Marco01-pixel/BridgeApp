...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo1464elapsedNowUwyO8pc() {
            return Duration.m1510minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* JADX INFO: renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo1467plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1511plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo1466minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m1480equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m1507isInfiniteimpl(this.offset)) {
                return Duration.INSTANCE.m1577getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m1510minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
        ...
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1480equalsimpl0(mo1466minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1577getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m1503hashCodeimpl(Duration.m1511plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1524toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m1577getZEROUwyO8pc(), null);
    }
}
