...
public final class DurationKt {
    ...
    private static final long m1601timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m1513timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m1600timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m1512timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }
    ...
    */
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m1475constructorimpl(normalNanos << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long normalMillis) {
        return Duration.m1475constructorimpl((normalMillis << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m1475constructorimpl((normalValue << 1) + ((long) unitDiscriminator));
    }
