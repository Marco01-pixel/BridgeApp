...
public final class UStringsKt {
    ...
    public static final String m1461toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1463toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1462toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1460toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compareUnsigned(data, UInt.m244constructorimpl(255)) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m244constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m424boximpl(UShort.m430constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m244constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m244constructorimpl(result * uradix);
            result = UInt.m244constructorimpl(UInt.m244constructorimpl(digit) + result2);
            if (Integer.compareUnsigned(result, result2) < 0) {
                return null;
            }
        }
        return UInt.m238boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m323constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m323constructorimpl(result * uradix);
            result = ULong.m323constructorimpl(ULong.m323constructorimpl(((long) UInt.m244constructorimpl(digit)) & 4294967295L) + result2);
        ...
        return ULong.m317boximpl(result);
    }
}
