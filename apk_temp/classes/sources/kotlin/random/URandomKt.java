...
public final class URandomKt {
    public static final int nextUInt(Random $this$nextUInt) {
        ...
        return UInt.m244constructorimpl($this$nextUInt.nextInt());
    }
    ...
    public static final int m1380nextUInta8DCA5k(Random nextUInt, int from, int until) {
        ...
        return UInt.m244constructorimpl(signedResult);
    }
    ...
    public static final int nextUInt(Random $this$nextUInt, UIntRange range) {
        ...
        return Integer.compareUnsigned(range.getLast(), -1) < 0 ? m1380nextUInta8DCA5k($this$nextUInt, range.getFirst(), UInt.m244constructorimpl(range.getLast() + 1)) : Integer.compareUnsigned(range.getFirst(), 0) > 0 ? UInt.m244constructorimpl(m1380nextUInta8DCA5k($this$nextUInt, UInt.m244constructorimpl(range.getFirst() - 1), range.getLast()) + 1) : nextUInt($this$nextUInt);
    }

    public static final long nextULong(Random $this$nextULong) {
        Intrinsics.checkNotNullParameter($this$nextULong, "<this>");
        return ULong.m323constructorimpl($this$nextULong.nextLong());
    }
    ...
    public static final long m1383nextULongjmpaWc(Random nextULong, long from, long until) {
        ...
        return ULong.m323constructorimpl(signedResult);
    }
    ...
    public static final long nextULong(Random $this$nextULong, ULongRange range) {
        ...
        if (Long.compareUnsigned(range.getLast(), -1L) < 0) {
            return m1383nextULongjmpaWc($this$nextULong, range.getFirst(), ULong.m323constructorimpl(range.getLast() + ULong.m323constructorimpl(((long) 1) & 4294967295L)));
        }
        if (Long.compareUnsigned(range.getFirst(), 0L) <= 0) {
            return nextULong($this$nextULong);
        }
        long j = ((long) 1) & 4294967295L;
        return ULong.m323constructorimpl(m1383nextULongjmpaWc($this$nextULong, ULong.m323constructorimpl(range.getFirst() - ULong.m323constructorimpl(j)), range.getLast()) + ULong.m323constructorimpl(j));
    }
    ...
    public static final byte[] nextUBytes(Random $this$nextUBytes, int size) {
        ...
        return UByteArray.m220constructorimpl($this$nextUBytes.nextBytes(size));
    }
    ...
    public static final void m1375checkUIntRangeBoundsJ1ME1BU(int from, int until) {
        if (!(Integer.compareUnsigned(until, from) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(UInt.m238boximpl(from), UInt.m238boximpl(until)).toString());
        }
    }
    ...
    public static final void m1376checkULongRangeBoundseb3DHEI(long from, long until) {
        if (!(Long.compareUnsigned(until, from) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(ULong.m317boximpl(from), ULong.m317boximpl(until)).toString());
        }
    }
}
