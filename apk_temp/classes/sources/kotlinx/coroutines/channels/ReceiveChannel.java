...
public interface ReceiveChannel<E> {
    ...
    Object mo1654receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1655tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1655tryReceivePtdJZtk = receiveChannel.mo1655tryReceivePtdJZtk();
            if (ChannelResult.m1671isSuccessimpl(objMo1655tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1667getOrThrowimpl(objMo1655tryReceivePtdJZtk);
            }
            Throwable thM1665exceptionOrNullimpl = ChannelResult.m1665exceptionOrNullimpl(objMo1655tryReceivePtdJZtk);
            if (thM1665exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1665exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) throws java.lang.Throwable {
            ...
            L38:
                ...
                r2 = 1
                r4.label = r2
                java.lang.Object r3 = r3.mo1654receiveCatchingJP2dKIU(r4)
                if (r3 != r1) goto L45
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m1666getOrNullimpl(r3)
                return r3
            */
