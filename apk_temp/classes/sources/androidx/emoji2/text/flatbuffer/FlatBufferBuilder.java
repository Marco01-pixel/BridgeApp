...
public class FlatBufferBuilder {
    ...
    public void prep(int size, int additional_bytes) {
        ...
        while (this.space < align_size + size + additional_bytes) {
            ...
            ByteBuffer byteBufferGrowByteBuffer = growByteBuffer(old, this.bb_factory);
            this.bb = byteBufferGrowByteBuffer;
            if (old != byteBufferGrowByteBuffer) {
    ...
    public int endTable() {
        ...
        if (existing_vtable != 0) {
            int iCapacity = this.bb.capacity() - vtableloc;
            this.space = iCapacity;
            this.bb.putInt(iCapacity, existing_vtable - vtableloc);
        } else {
