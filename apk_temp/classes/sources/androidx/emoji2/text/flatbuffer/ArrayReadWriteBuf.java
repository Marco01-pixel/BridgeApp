...
public class ArrayReadWriteBuf implements ReadWriteBuf {
    ...
    public long getLong(int index) {
        byte[] bArr = this.buffer;
        int index2 = index + 1;
        long j = ((long) bArr[index]) & 255;
        int index3 = index2 + 1;
        int index4 = index3 + 1;
        long j2 = j | ((((long) bArr[index2]) & 255) << 8) | ((((long) bArr[index3]) & 255) << 16);
        int index5 = index4 + 1;
        long j3 = j2 | ((((long) bArr[index4]) & 255) << 24);
        int index6 = index5 + 1;
        long j4 = j3 | ((((long) bArr[index5]) & 255) << 32);
        int index7 = index6 + 1;
        return j4 | ((((long) bArr[index6]) & 255) << 40) | ((255 & ((long) bArr[index7])) << 48) | (((long) bArr[index7 + 1]) << 56);
    }
