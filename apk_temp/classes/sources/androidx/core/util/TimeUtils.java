...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long duration, int fieldLen) {
        ...
        if (seconds2 <= 86400) {
            ...
            int days2 = seconds2 / 86400;
            seconds2 -= 86400 * days2;
            days = days2;
        }
        if (seconds2 <= 3600) {
            hours = 0;
        ...
        if (fieldLen != 0) {
            ...
            for (int myLen4 = r5 + accumField(millis, 2, true, myLen3 + accumField(seconds, 1, myLen3 > 0, 2) > 0 ? 3 : 0) + 1; myLen4 < fieldLen; myLen4++) {
                formatStr[pos] = ' ';
                pos++;
            }
        }
        ...
        start = pos3;
        pos2 = 0;
        int pos82 = printField(formatStr, millis, 'm', pos7, true, pos2);
        formatStr[pos82] = 's';
        return pos82 + 1;
    }
