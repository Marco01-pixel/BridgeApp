        ...
        while (true) {
            ...
            if (i2 < dArr.length) {
                ...
                if (motion != null) {
                    ...
                    float pos_x = (float) ((((double) rx) + (((double) radius) * Math.sin(v_y4))) - ((double) (v_width3 / 2.0f)));
                    float pos_y = (float) ((((double) ry) - (((double) radius) * Math.cos(v_y4))) - ((double) (v_height2 / 2.0f)));
                    double d = dradius;
                    v_width = v_width3;
                    v_height = v_height2;
                    float dpos_x = (float) (((double) drx) + (d * Math.sin(v_y4)) + (((double) radius) * Math.cos(v_y4) * ((double) dangle)));
                    float dpos_y = (float) ((((double) dry) - (((double) dradius) * Math.cos(v_y4))) + (((double) radius) * Math.sin(v_y4) * ((double) dangle)));
                    v_x = pos_x;
                    if (slope.length >= 2) {
                        slope[0] = dpos_x;
                        slope[1] = dpos_y;
                    ...
                    if (!Float.isNaN(path_rotate2)) {
                        ...
                        float rot2 = (float) (((double) 0.0f) + ((double) path_rotate2) + Math.toDegrees(Math.atan2(dy, dx)));
