...
public class Motion implements TypedValues {
    ...
    public void buildPath(float[] points, int pointCount) {
        ...
        HashMap<String, SplineSet> map2 = motion.mAttributesMap;
        SplineSet trans_y = map2 == null ? null : map2.get("translationY");
        HashMap<String, KeyCycleOscillator> map3 = motion.mCycleMap;
        KeyCycleOscillator osc_x = map3 == null ? null : map3.get("translationX");
        HashMap<String, KeyCycleOscillator> map4 = motion.mCycleMap;
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        if (!splineAttributes2.isEmpty()) {
            ...
            for (String attribute2 : splineAttributes2) {
        ...
        if (!timeCycleAttributes3.isEmpty()) {
            ...
            Iterator<String> it2 = timeCycleAttributes3.iterator();
            while (it2.hasNext()) {
                String attribute3 = it2.next();
    ...
    public boolean interpolate(MotionWidget child, float global_position, long time, KeyCache keyCache) {
        ...
        if (map != null) {
            for (SplineSet aSpline : map.values()) {
        ...
        if (map2 != null) {
            for (KeyCycleOscillator osc : map2.values()) {
    ...
    void getPostLayoutDvDp(float position, int width, int height, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        SplineSet rotation = map3 == null ? null : map3.get("rotationZ");
        ...
        KeyCycleOscillator osc_r = map8 == null ? null : map8.get("rotationZ");
