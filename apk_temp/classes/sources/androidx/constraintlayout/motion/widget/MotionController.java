...
public class MotionController {
    ...
    void buildPath(float[] points, int pointCount) {
        ...
        HashMap<String, ViewSpline> map = motionController.mAttributesMap;
        SplineSet trans_x = map == null ? null : map.get("translationX");
        HashMap<String, ViewSpline> map2 = motionController.mAttributesMap;
        SplineSet trans_y = map2 == null ? null : map2.get("translationY");
        HashMap<String, ViewOscillator> map3 = motionController.mCycleMap;
        ViewOscillator osc_x = map3 == null ? null : map3.get("translationX");
        HashMap<String, ViewOscillator> map4 = motionController.mCycleMap;
        ViewOscillator osc_y = map4 != null ? map4.get("translationY") : null;
        int i = 0;
        while (i < pointCount) {
    ...
    */
    ...
    void getPostLayoutDvDp(float position, int width, int height, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        SplineSet rotation = map3 == null ? null : map3.get(Key.ROTATION);
        ...
        ViewOscillator osc_x = map6 == null ? null : map6.get("translationX");
        HashMap<String, ViewOscillator> map7 = this.mCycleMap;
        ViewOscillator osc_y = map7 == null ? null : map7.get("translationY");
        HashMap<String, ViewOscillator> map8 = this.mCycleMap;
        ViewOscillator osc_r = map8 == null ? null : map8.get(Key.ROTATION);
        HashMap<String, ViewOscillator> map9 = this.mCycleMap;
        ViewOscillator osc_sx = map9 == null ? null : map9.get("scaleX");
        HashMap<String, ViewOscillator> map10 = this.mCycleMap;
        ViewOscillator osc_sy = map10 != null ? map10.get("scaleY") : null;
