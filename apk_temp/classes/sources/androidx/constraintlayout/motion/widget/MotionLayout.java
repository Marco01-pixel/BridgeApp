...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    */
    ...
    protected void dispatchDraw(Canvas canvas) {
        ArrayList<MotionHelper> arrayList = this.mDecoratorsHelpers;
        if (arrayList != null) {
            for (MotionHelper decor : arrayList) {
        ...
        if ((this.mDebugPath & 1) == 1 && !isInEditMode()) {
            ...
            StringBuilder sbAppend = new StringBuilder().append(this.mLastFps + " fps " + Debug.getState(this, this.mBeginState) + " -> ").append(Debug.getState(this, this.mEndState)).append(" (progress: ").append(p).append(" ) state=");
            int i = this.mCurrentState;
            String str = sbAppend.append(i == -1 ? "undefined" : Debug.getState(this, i)).toString();
        ...
        if (arrayList2 != null) {
            for (MotionHelper decor2 : arrayList2) {
    ...
    public void fireTrigger(int triggerId, boolean positive, float progress) {
        ...
        CopyOnWriteArrayList<TransitionListener> copyOnWriteArrayList = this.mTransitionListeners;
        if (copyOnWriteArrayList != null) {
            for (TransitionListener listeners : copyOnWriteArrayList) {
        ...
        if ((this.mTransitionListener != null || ((copyOnWriteArrayList = this.mTransitionListeners) != null && !copyOnWriteArrayList.isEmpty())) && this.mListenerPosition != this.mTransitionPosition) {
            if (this.mListenerState != -1) {
                ...
                if (copyOnWriteArrayList2 != null) {
                    for (TransitionListener listeners : copyOnWriteArrayList2) {
            ...
            if (copyOnWriteArrayList3 != null) {
                for (TransitionListener listeners2 : copyOnWriteArrayList3) {
