...
class MotionPaths implements Comparable<MotionPaths> {
        ...
        switch (c.mPositionType) {
            ...
            case 2:
                if (Float.isNaN(c.mPercentX)) {
                    float f9 = e.x;
                    float f10 = s.x;
                    fMin = ((f9 - f10) * position) + f10;
                } else {
                    fMin = c.mPercentX * Math.min(scaleHeight, scaleWidth);
                }
                this.x = fMin;
                if (Float.isNaN(c.mPercentY)) {
                    float f11 = e.y;
    ...
    void getCenter(double p, int[] toUse, double[] data, float[] point, int offset) {
        ...
        if (motionController != null) {
            ...
            float radius = v_x;
            float angle = v_y;
            float v_x2 = (float) ((((double) rx) + (((double) radius) * Math.sin(angle))) - ((double) (v_width / 2.0f)));
            f = 2.0f;
    ...
    void getCenter(double p, int[] toUse, double[] data, float[] point, double[] vdata, float[] velocity) {
        ...
        if (motionController != null) {
            ...
            float drx = vel[0];
            float v_x2 = vel[1];
            float v_x3 = (float) ((((double) rx) + (((double) radius) * Math.sin(angle))) - ((double) (v_width / 2.0f)));
            float v_y2 = (float) ((((double) ry) - (((double) radius) * Math.cos(angle))) - ((double) (v_height / 2.0f)));
            float dpos_x = (float) (((double) drx) + (((double) dradius) * Math.sin(angle)) + (Math.cos(angle) * ((double) dangle2)));
            dpos_y = (float) ((((double) v_x2) - (((double) dradius) * Math.cos(angle))) + (Math.sin(angle) * ((double) dangle2)));
            v_y = v_y2;
            dangle = dpos_x;
            v_x = v_x3;
        }
        ...
        while (true) {
            ...
            if (i2 < dArr.length) {
                ...
                if (motionController != null) {
                    ...
                    float pos_x = (float) ((((double) rx) + (((double) radius) * Math.sin(angle))) - ((double) (v_width2 / 2.0f)));
                    float pos_y = (float) ((((double) ry) - (((double) radius) * Math.cos(angle))) - ((double) (v_height2 / 2.0f)));
                    v_height = v_height2;
                    dangle = v_width2;
                    float dpos_x = (float) (((double) v_y4) + (((double) dradius) * Math.sin(angle)) + (((double) radius) * Math.cos(angle) * ((double) dangle2)));
                    float dpos_y = (float) ((((double) dry) - (((double) dradius) * Math.cos(angle))) + (((double) radius) * Math.sin(angle) * ((double) dangle2)));
                    v_x = pos_x;
                    if (slope.length < 2) {
                        z2 = true;
                        z = false;
                    ...
                    if (Float.isNaN(angle2)) {
                        ...
                        float rot = (float) (((double) angle2) + Math.toDegrees(Math.atan2(dpos_y, dpos_x)));
                        view2 = view;
        ...
        while (true) {
            ...
            if (i < toUse.length) {
                ...
                if (motionController == null) {
                    ...
                    float radius = v_x;
                    angle = 0.0f;
                    float v_x2 = (float) ((((double) rx) + (((double) radius) * Math.sin(v_y))) - ((double) (v_width / 2.0f)));
                    v_y = (float) ((((double) ry) - (((double) radius) * Math.cos(v_y))) - ((double) (v_height / 2.0f)));
                    v_x = v_x2;
                }
                float x1 = v_x;
                float y1 = v_y;
