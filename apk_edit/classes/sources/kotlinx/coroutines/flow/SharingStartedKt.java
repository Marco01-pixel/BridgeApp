...
public final class SharingStartedKt {
    ...
    public static /* synthetic */ SharingStarted m1584WhileSubscribed5qebJ5I$default(SharingStarted.Companion companion, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = Duration.INSTANCE.m1472getZEROUwyO8pc();
        }
        if ((i & 2) != 0) {
            j2 = Duration.INSTANCE.m1470getINFINITEUwyO8pc();
        }
        return m1583WhileSubscribed5qebJ5I(companion, j, j2);
    }

    /* JADX INFO: renamed from: WhileSubscribed-5qebJ5I, reason: not valid java name */
    public static final SharingStarted m1583WhileSubscribed5qebJ5I(SharingStarted.Companion $this$WhileSubscribed_u2d5qebJ5I, long stopTimeout, long replayExpiration) {
        return new StartedWhileSubscribed(Duration.m1388getInWholeMillisecondsimpl(stopTimeout), Duration.m1388getInWholeMillisecondsimpl(replayExpiration));
    }
}
