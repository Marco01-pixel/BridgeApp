...
public final class ExecutorCoroutineDispatcherImpl extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo1597scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        Executor executor = getExecutor();
        ...
        if (scheduledFutureScheduleBlock != null) {
            ...
            DefaultExecutor.INSTANCE.mo1597scheduleResumeAfterDelay(timeMillis, continuation);
        }
    }
