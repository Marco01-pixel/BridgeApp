...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM44constructorimpl = Result.m44constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM44constructorimpl = Result.m44constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m50isFailureimpl(objM44constructorimpl) ? null : objM44constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1573installSignalHandler$lambda1(signal);
                }
            });
        } catch (Throwable th) {
        }
    ...
    public static final void m1573installSignalHandler$lambda1(Signal it) {
