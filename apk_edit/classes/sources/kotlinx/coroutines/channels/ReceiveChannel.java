...
public interface ReceiveChannel<E> {
    ...
    Object mo1549receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1550tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1550tryReceivePtdJZtk = receiveChannel.mo1550tryReceivePtdJZtk();
            if (ChannelResult.m1566isSuccessimpl(objMo1550tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1562getOrThrowimpl(objMo1550tryReceivePtdJZtk);
            }
            Throwable thM1560exceptionOrNullimpl = ChannelResult.m1560exceptionOrNullimpl(objMo1550tryReceivePtdJZtk);
            if (thM1560exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1560exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) throws java.lang.Throwable {
            ...
            L38:
                ...
                r2 = 1
                r4.label = r2
                java.lang.Object r3 = r3.mo1549receiveCatchingJP2dKIU(r4)
                if (r3 != r1) goto L45
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m1561getOrNullimpl(r3)
                return r3
            */
