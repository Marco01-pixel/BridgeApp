...
public interface SendChannel<E> {
    ...
    Object mo1551trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1551trySendJP2dKIU(e);
            if (ChannelResult.m1566isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1560exceptionOrNullimpl = ChannelResult.m1560exceptionOrNullimpl(result);
