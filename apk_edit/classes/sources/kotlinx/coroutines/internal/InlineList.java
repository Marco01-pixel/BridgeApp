...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m1585boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static <E> Object m1586constructorimpl(Object obj) {
        return obj;
    }
    ...
    public static int m1591hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public static String m1593toStringimpl(Object obj) {
        return "InlineList(holder=" + obj + ')';
    }

    public boolean equals(Object obj) {
        return m1588equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m1591hashCodeimpl(this.holder);
    }

    public String toString() {
        return m1593toStringimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m1587constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m1586constructorimpl(obj);
    }

    /* JADX INFO: renamed from: plus-FjFbRPM, reason: not valid java name */
    public static final Object m1592plusFjFbRPM(Object arg0, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(e instanceof List))) {
            throw new AssertionError();
        }
        if (arg0 == null) {
            return m1586constructorimpl(e);
        }
        if (arg0 instanceof ArrayList) {
            ...
            return m1586constructorimpl(arg0);
        }
        ArrayList list = new ArrayList(4);
        list.add(arg0);
        list.add(e);
        return m1586constructorimpl(list);
    }

    /* JADX INFO: renamed from: forEachReversed-impl, reason: not valid java name */
    public static final void m1590forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj == null) {
            return;
        }
