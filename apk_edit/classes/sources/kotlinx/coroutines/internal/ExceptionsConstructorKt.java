...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        Object objM44constructorimpl;
        if (e instanceof CopyableThrowable) {
            try {
                Result.Companion companion = Result.INSTANCE;
                objM44constructorimpl = Result.m44constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM44constructorimpl = Result.m44constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m50isFailureimpl(objM44constructorimpl)) {
                objM44constructorimpl = null;
            }
            return (E) objM44constructorimpl;
        }
            ...
            case 0:
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$4
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        it.initCause(e);
                        objM44constructorimpl = Result.m44constructorimpl(it);
                        if (Result.m50isFailureimpl(objM44constructorimpl)) {
                            objM44constructorimpl = null;
                        }
                        return (Throwable) objM44constructorimpl;
                    }
                };
            case 1:
                ...
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$2
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        objM44constructorimpl = Result.m44constructorimpl((Throwable) objNewInstance);
                        if (Result.m50isFailureimpl(objM44constructorimpl)) {
                            objM44constructorimpl = null;
                        }
                        return (Throwable) objM44constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    objM44constructorimpl = Result.m44constructorimpl(function12.invoke(e));
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM44constructorimpl = Result.m44constructorimpl(ResultKt.createFailure(th));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM44constructorimpl = Result.m44constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM44constructorimpl = Result.m44constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m50isFailureimpl(objM44constructorimpl)) {
            objM44constructorimpl = numValueOf;
        }
        return ((Number) objM44constructorimpl).intValue();
    }
