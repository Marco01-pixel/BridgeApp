...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM44constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM44constructorimpl = Result.m44constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM44constructorimpl = Result.m44constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m47exceptionOrNullimpl(objM44constructorimpl) == null) {
            obj2 = objM44constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM44constructorimpl2 = Result.m44constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM44constructorimpl2 = Result.m44constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m47exceptionOrNullimpl(objM44constructorimpl2) == null) {
            obj = objM44constructorimpl2;
        }
