        ...
        result.addSource(liveData, new Observer<X>() { // from class: androidx.lifecycle.Transformations.switchMap.1
            ...
            public void onChanged(X value) {
                ...
                if (liveData3 != null) {
                    ...
                    mediatorLiveData.removeSource((LiveData<S>) liveData3);
                }
                this.liveData = liveData2;
                if (liveData2 != null) {
                    ...
                    mediatorLiveData2.addSource((LiveData<S>) liveData2, new Transformations$sam$androidx_lifecycle_Observer$0(new Function1<Y, Unit>() { // from class: androidx.lifecycle.Transformations$switchMap$1$onChanged$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
        ...
        result.addSource($this$switchMap, new Observer<X>() { // from class: androidx.lifecycle.Transformations.switchMap.2
            ...
            public void onChanged(X value) {
                ...
                if (liveData2 != null) {
                    MediatorLiveData<Y> mediatorLiveData = result;
                    Intrinsics.checkNotNull(liveData2);
                    mediatorLiveData.removeSource((LiveData<S>) liveData2);
                }
                this.liveData = liveData;
                if (liveData != null) {
                    MediatorLiveData<Y> mediatorLiveData2 = result;
                    ...
                    final MediatorLiveData<Y> mediatorLiveData3 = result;
                    mediatorLiveData2.addSource((LiveData<S>) liveData, new Transformations$sam$androidx_lifecycle_Observer$0(new Function1<Y, Unit>() { // from class: androidx.lifecycle.Transformations$switchMap$2$onChanged$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
