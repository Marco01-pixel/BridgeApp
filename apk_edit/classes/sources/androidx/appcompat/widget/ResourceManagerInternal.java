...
public final class ResourceManagerInternal {
    ...
    boolean tintDrawableUsingColorFilter(Context context, int resId, Drawable drawable) {
        ResourceManagerHooks resourceManagerHooks = this.mHooks;
        if (resourceManagerHooks == null || !resourceManagerHooks.tintDrawableUsingColorFilter(context, resId, drawable)) {
            return DEBUG;
        }
        return true;
    }
    ...
    static void tintDrawable(Drawable drawable, TintInfo tint, int[] state) {
        ...
        if (DrawableUtils.canSafelyMutateDrawable(drawable)) {
            boolean mutated = drawable.mutate() == drawable ? true : DEBUG;
            if (!mutated) {
