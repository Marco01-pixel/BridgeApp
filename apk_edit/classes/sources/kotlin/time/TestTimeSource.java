...
public final class TestTimeSource extends AbstractLongTimeSource {
    ...
    public final void m1505plusAssignLRDsOJo(long duration) {
        long newReading;
        long longDelta = Duration.m1416toLongimpl(duration, getUnit());
        if (longDelta != Long.MIN_VALUE && longDelta != Long.MAX_VALUE) {
            ...
            double delta = Duration.m1413toDoubleimpl(duration, getUnit());
    ...
    private final void m1504overflowLRDsOJo(long duration) {
        throw new IllegalStateException("TestTimeSource will overflow if its reading " + this.reading + DurationUnitKt.shortName(getUnit()) + " is advanced by " + ((Object) Duration.m1419toStringimpl(duration)) + '.');
    }
}
