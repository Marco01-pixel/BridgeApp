...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1264getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM218constructorimpl = ((int) ULong.m218constructorimpl(j ^ ULong.m218constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM218constructorimpl2 = (iM218constructorimpl + ((int) ULong.m218constructorimpl(j2 ^ ULong.m218constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + iM218constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sbAppend = sb.append((Object) ULong.m264toStringimpl(this.first)).append("..").append((Object) ULong.m264toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
            sbAppend = sb.append((Object) ULong.m264toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m264toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1290fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
