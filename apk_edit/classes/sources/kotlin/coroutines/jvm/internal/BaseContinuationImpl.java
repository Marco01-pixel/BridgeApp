    ...
    public final void resumeWith(Object result) {
        ...
        while (true) {
            ...
            try {
                ...
                objM44constructorimpl = Result.m44constructorimpl(ResultKt.createFailure(exception));
            }
            if (outcome == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                return;
            }
            Result.Companion companion2 = Result.INSTANCE;
            objM44constructorimpl = Result.m44constructorimpl(outcome);
            Object outcome2 = objM44constructorimpl;
