...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] result = UByteArray.m114constructorimpl(collection.size());
        int index = 0;
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        long[] result = ULongArray.m272constructorimpl(collection.size());
        int index = 0;
        Iterator<ULong> it = collection.iterator();
        while (it.hasNext()) {
            long element = it.next().getData();
            ULongArray.m283setk8EXiF4(result, index, element);
            index++;
        }
        return result;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] result = UShortArray.m377constructorimpl(collection.size());
        int index = 0;
        Iterator<UShort> it = collection.iterator();
        while (it.hasNext()) {
            short element = it.next().getData();
            UShortArray.m388set01HTLdE(result, index, element);
            index++;
        }
        return result;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        while (it.hasNext()) {
            int element = it.next().getData();
            sum = UInt.m139constructorimpl(sum + element);
        }
        return sum;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        while (it.hasNext()) {
            byte element = it.next().getData();
            sum = UInt.m139constructorimpl(UInt.m139constructorimpl(element & UByte.MAX_VALUE) + sum);
        }
        return sum;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        while (it.hasNext()) {
            short element = it.next().getData();
            sum = UInt.m139constructorimpl(UInt.m139constructorimpl(65535 & element) + sum);
        }
        return sum;
    }
}
