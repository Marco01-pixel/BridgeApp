...
public final class UShortArray implements Collection<UShort>, KMappedMarker {
    ...
    public static final /* synthetic */ UShortArray m376boximpl(short[] sArr) {
        return new UShortArray(sArr);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static short[] m378constructorimpl(short[] storage) {
        Intrinsics.checkNotNullParameter(storage, "storage");
        return storage;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m381equalsimpl(short[] sArr, Object obj) {
        return (obj instanceof UShortArray) && Intrinsics.areEqual(sArr, ((UShortArray) obj).getStorage());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m382equalsimpl0(short[] sArr, short[] sArr2) {
    ...
    public final /* bridge */ boolean contains(Object element) {
        if (element instanceof UShort) {
            return m391containsxj2QHRw(((UShort) element).getData());
        }
        return false;
    }
    ...
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static short[] m377constructorimpl(int size) {
        return m378constructorimpl(new short[size]);
    }

    /* JADX INFO: renamed from: get-Mh2AYeg, reason: not valid java name */
    public static final short m383getMh2AYeg(short[] arg0, int index) {
        return UShort.m325constructorimpl(arg0[index]);
    }

    /* JADX INFO: renamed from: set-01HTLdE, reason: not valid java name */
    public static final void m388set01HTLdE(short[] arg0, int index, short value) {
        arg0[index] = value;
    }

    /* JADX INFO: renamed from: getSize-impl, reason: not valid java name */
    public static int m384getSizeimpl(short[] arg0) {
        return arg0.length;
    }
    ...
    public static java.util.Iterator<UShort> m387iteratorimpl(short[] arg0) {
    ...
    private static final class Iterator implements java.util.Iterator<UShort>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ UShort next() {
            return UShort.m319boximpl(m393nextMh2AYeg());
        }
        ...
        public short m393nextMh2AYeg() {
            ...
            this.index = i + 1;
            return UShort.m325constructorimpl(sArr[i]);
        }
    }

    /* JADX INFO: renamed from: contains-xj2QHRw, reason: not valid java name */
    public boolean m391containsxj2QHRw(short element) {
        return m379containsxj2QHRw(this.storage, element);
    }

    /* JADX INFO: renamed from: contains-xj2QHRw, reason: not valid java name */
    public static boolean m379containsxj2QHRw(short[] arg0, short element) {
    ...
    public static boolean m380containsAllimpl(short[] arg0, Collection<UShort> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
    ...
    public static boolean m386isEmptyimpl(short[] arg0) {
