...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class C00381<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C00381(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super C00381> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00381 c00381 = new C00381(this.$this_ifEmpty, this.$defaultValue, continuation);
            c00381.L$0 = obj;
            return c00381;
        }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C00381(sequence, defaultValue, null));
    }
    ...
    static final class C00391<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00391(Sequence<? extends T> sequence, Random random, Continuation<? super C00391> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00391 c00391 = new C00391(this.$this_shuffled, this.$random, continuation);
            c00391.L$0 = obj;
            return c00391;
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    mutableList = SequencesKt.toMutableList(c00391.$this_shuffled);
                    break;
                case 1:
                    c00391 = this;
                    mutableList = (List) c00391.L$1;
                    SequenceScope sequenceScope2 = (SequenceScope) c00391.L$0;
                    ResultKt.throwOnFailure(obj);
            ...
            while (!mutableList.isEmpty()) {
                int iNextInt = c00391.$random.nextInt(mutableList.size());
                ...
                c00391.L$1 = mutableList;
                c00391.label = 1;
                if (sequenceScope.yield(objRemoveLast, c00391) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            return Unit.INSTANCE;
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> sequence, Random random) {
        ...
        return SequencesKt.sequence(new C00391(sequence, random, null));
    }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    i = 0;
                    it = c00341.$source.iterator();
                    break;
                case 1:
                    c00341 = this;
                    i = c00341.I$0;
                    it = (Iterator) c00341.L$1;
                    sequenceScope = (SequenceScope) c00341.L$0;
                    ResultKt.throwOnFailure(obj);
                    break;
                default:
            ...
            while (it.hasNext()) {
                Object next = it.next();
                Function2<Integer, T, C> function2 = c00341.$transform;
                int i2 = i + 1;
                if (i < 0) {
                ...
                c00341.I$0 = i2;
                c00341.label = 1;
                if (sequenceScope.yieldAll(c00341.$iterator.invoke((C) objInvoke), c00341) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                i = i2;
            }
