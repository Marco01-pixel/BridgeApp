...
public final class UnsignedKt {
    ...
    public static final int m395uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m139constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }

    /* JADX INFO: renamed from: uintRemainder-J1ME1BU, reason: not valid java name */
    public static final int m396uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m139constructorimpl((int) ((((long) v1) & 4294967295L) % (4294967295L & ((long) v2))));
    }

    /* JADX INFO: renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m397ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m218constructorimpl(Long.compare(v1 ^ Long.MIN_VALUE, v2 ^ Long.MIN_VALUE) >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
        ...
        return ULong.m218constructorimpl(((long) (Long.compare(ULong.m218constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m218constructorimpl(v2) ^ Long.MIN_VALUE) < 0 ? 0 : 1)) + quotient);
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m398ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
        ...
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        if (Long.compare(ULong.m218constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m218constructorimpl(v2) ^ Long.MIN_VALUE) >= 0) {
            j = v2;
        }
    ...
    public static final int doubleToUInt(double v) {
        ...
        return v <= 2.147483647E9d ? UInt.m139constructorimpl((int) v) : UInt.m139constructorimpl(UInt.m139constructorimpl((int) (v - ((double) Integer.MAX_VALUE))) + UInt.m139constructorimpl(Integer.MAX_VALUE));
    }
