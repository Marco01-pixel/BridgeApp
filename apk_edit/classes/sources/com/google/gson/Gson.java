    ...
    public <T> TypeAdapter<T> getAdapter(TypeToken<T> type) {
        ...
        try {
            ...
            for (TypeAdapterFactory factory : this.factories) {
                ...
                if (candidate != null) {
                    TypeAdapter<T> existingAdapter = (TypeAdapter) this.typeTokenCache.putIfAbsent(type, candidate);
    ...
    public void toJson(Object src, Type typeOfSrc, JsonWriter writer) throws JsonIOException {
        ...
        try {
            try {
                ...
                AssertionError error = new AssertionError("AssertionError (GSON 2.10): " + e2.getMessage());
                error.initCause(e2);
                throw error;
            }
        } finally {
